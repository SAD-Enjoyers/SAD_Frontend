        ...
        >
          ...
          >
            ...
            <Typography variant="body1">
              Our platform helps companies discover skilled professionals and
              easily explore their detailed profiles, making recruitment
              smoother. Users can also highlight their resumes, boosting their
              visibility and creating more opportunities for collaboration and
              job offers from companies.
            </Typography>
            <Link component={RouterLink} to={"/SearchUsers"}>
              <Button
                variant="contained"
                color="primary"
                sx={{ marginTop: "10px" }}
