...
const CardComponent = ({ title, description, linkText, linkUrl }) => {
    return (
        ...
        >
            <Typography variant="h5" className="cardTitle" sx={{ fontWeight: 'bold', fontSize: '1.6rem', color: '#333', marginBottom: '8px' }}>
                {title}
            </Typography>
            <Typography variant="body1" className="cardDescription" sx={{ fontSize: '1.2rem', color: '#555', marginBottom: '16px', lineHeight: '1.6' }}>
                {description}
            </Typography>
            <Typography
                component="a"
    ...
    return (
        <Container maxWidth="lg" sx={{ marginTop: '100px', direction: 'ltr' }}>
            <Grid2 container spacing={4} alignItems="center" justifyContent="center">
                <Grid2 size={{xs:0,md:4}} sx={{ display: { xs: 'none', lg: 'block' } }}>
                    <Box
                        sx={{
                            position: 'relative',
                            width: '400px',
                ...
                <Grid2 size={{xs:12,md:8}}>
                    <Grid2 container direction="column" spacing={2} justifyContent="center" alignItems="center" sx={{ textAlign: 'center', minHeight: '500px' }}>
