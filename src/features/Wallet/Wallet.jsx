...
//   // Fetch account information and transactions from the API
//   useEffect(() => {
...
//         setAccountInfo(response.data.data.result)
...
//           },
//         })
//         const transformedTransactions = response.data.data.result.map((tx) => ({
//           amount: tx.volume,
//           date: tx.time,
//           type: tx.type,
//         }));
...
//   // Handle adding a new card number
