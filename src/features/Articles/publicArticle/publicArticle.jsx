...
import React, { useState, useEffect } from "react";
import {Grid, Rating, Box, Typography, Chip, Card, Button, CircularProgress, TextField, List, ListItem, ListItemAvatar, ListItemText, Divider, Avatar } from "@mui/material";
import CommentIcon from "@mui/icons-material/Comment";
import { styled } from "@mui/system";
import AccessTimeIcon from "@mui/icons-material/AccessTime";
import PeopleIcon from "@mui/icons-material/People";
...
const articleData = {
    ...
    description: "Learn the fundamentals of React.js, including state management, components, and hooks.",
    level: "Beginner",
    tag1: "React",
    tag2: "JavaScript",
...
// Mock comments data
const mockComments = [
    { id: 1, name: "John Doe", comment: "Great article! Learned a lot about React." },
    { id: 2, name: "Jane Smith", comment: "The explanation of hooks was very helpful." },
    { id: 3, name: "Alex Johnson", comment: "I love the practical examples included in the article." },
];
